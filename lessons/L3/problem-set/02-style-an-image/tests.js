...
function performSubmission() {
  ...
  grader.addTest(function() {
    return (grader.propertyIsGreaterThan($('.kitten-image'), 'border-top-width', '0px') && grader.propertyIsGreaterThan($('.kitten-image'), 'border-bottom-width', '0px') && grader.propertyIsGreaterThan($('.kitten-image'), 'border-left-width', '0px') && grader.propertyIsGreaterThan($('.kitten-image'), 'border-right-width', '0px'));
  }, {
    wrongMessage: "The kitten image is missing a border. Try using the border or border-width property."
  }, false);

  grader.addTest(function() {
    return (grader.hasCorrectStyle($('.kitten-image'), 'border-top-width', '5px') && grader.hasCorrectStyle($('.kitten-image'), 'border-bottom-width', '5px') && grader.hasCorrectStyle($('.kitten-image'), 'border-left-width', '5px') && grader.hasCorrectStyle($('.kitten-image'), 'border-right-width', '5px') && grader.hasCorrectStyle($('.kitten-image'), 'border-top-style', 'dashed') && grader.hasCorrectStyle($('.kitten-image'), 'border-bottom-style', 'dashed') && grader.hasCorrectStyle($('.kitten-image'), 'border-left-style', 'dashed') && grader.hasCorrectStyle($('.kitten-image'), 'border-right-style', 'dashed') && grader.hasCorrectStyle($('.kitten-image'), 'border-top-color', 'rgb(250, 128, 114)') && grader.hasCorrectStyle($('.kitten-image'), 'border-bottom-color', 'rgb(250, 128, 114)') && grader.hasCorrectStyle($('.kitten-image'), 'border-left-color', 'rgb(250, 128, 114)') && grader.hasCorrectStyle($('.kitten-image'), 'border-right-color', 'rgb(250, 128, 114)') && grader.propertyIsGreaterThan($('.kitten-image'), 'border-top-left-radius', '0px') && grader.propertyIsGreaterThan($('.kitten-image'), 'border-top-right-radius', '0px') && grader.propertyIsGreaterThan($('.kitten-image'), 'border-bottom-left-radius', '0px') && grader.propertyIsGreaterThan($('.kitten-image'), 'border-bottom-right-radius', '0px'));
  }, {
    wrongMessage: "Check your border's style."
  });

  grader.addTest(function() {
    return (grader.hasCorrectStyle($('.kitten-image'), 'border-top-width', '5px') && grader.hasCorrectStyle($('.kitten-image'), 'border-bottom-width', '5px') && grader.hasCorrectStyle($('.kitten-image'), 'border-left-width', '5px') && grader.hasCorrectStyle($('.kitten-image'), 'border-right-width', '5px'));
  }, {
    wrongMessage: "The border's width looks off. Try setting the border's width to 5 pixels instead."
  }, false);

  grader.addTest(function() {
    return (grader.hasCorrectStyle($('.kitten-image'), 'border-top-style', 'dashed') && grader.hasCorrectStyle($('.kitten-image'), 'border-bottom-style', 'dashed') && grader.hasCorrectStyle($('.kitten-image'), 'border-left-style', 'dashed') && grader.hasCorrectStyle($('.kitten-image'), 'border-right-style', 'dashed'));
  }, {
    wrongMessage: "The border around the kitten image has spaces.\nSee the different values for border-style using a CSS reference."
  }, false);

  grader.addTest(function() {
    return (grader.hasCorrectStyle($('.kitten-image'), 'border-top-color', 'rgb(250, 128, 114)') && grader.hasCorrectStyle($('.kitten-image'), 'border-bottom-color', 'rgb(250, 128, 114)') && grader.hasCorrectStyle($('.kitten-image'), 'border-left-color', 'rgb(250, 128, 114)') && grader.hasCorrectStyle($('.kitten-image'), 'border-right-color', 'rgb(250, 128, 114)'));
  }, {
    wrongMessage: "The border color looks wrong.\nRemember, you can use named color values, like blue or silver, in CSS."
  }, false);

  grader.addTest(function() {
    return (grader.propertyIsGreaterThan($('.kitten-image'), 'border-top-left-radius', '0px') && grader.propertyIsGreaterThan($('.kitten-image'), 'border-top-right-radius', '0px') && grader.propertyIsGreaterThan($('.kitten-image'), 'border-bottom-left-radius', '0px') && grader.propertyIsGreaterThan($('.kitten-image'), 'border-bottom-right-radius', '0px'));
  }, {
    wrongMessage: "The border around the kitten image needs rounded corners.\nHave you investigated all the different border properties in CSS yet?"
  }, false);

  grader.addTest(function() {
    return grader.hasCorrectStyle($('.kitten-image'), 'cursor', 'pointer');
  }, {
    wrongMessage: "When you hover over the kitten image, the mouse cursor should be pointing.\nWhat property changes the mouse cursor? Try searching online to find the answer."
  }, false);

  grader.addTest(function() {
    return !grader.hasCorrectStyle($('.kitten-image'), 'box-shadow', 'none');
  }, {
    wrongMessage: "You've almost got it!\nWhat's missing is subtle, but the kitten image should have a shadow.\nGo back and take a look at the box-shadow property."
  });
  ...
  result = {
    ...
    congrats: "Awesome! As a front-end developer, it is common to replicate a concept in CSS."
  };
  return result;
};